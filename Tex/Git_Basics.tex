...
\draw (current page.center) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering Git Basics\\[15pt] % Book title
{\Large Something to be Committed to Learn}\\[20pt] % Subtitle
...
\input{Chapters/02-workflow.tex}
\input{Chapters/03-backtracking.tex}
\input{Chapters/04-branching.tex}
\input{Chapters/05-teamwork.tex}
\end{document}
